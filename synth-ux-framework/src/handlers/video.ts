...
export async function handleVideoStartRecording(args: Record<string, unknown>): Promise<string> {
...
export async function handleVideoStopRecording(args: Record<string, unknown>): Promise<string> {
...
export async function handleVideoListRecordings(): Promise<string> {
  const videosDir = path.join(OUTPUT_DIR, 'videos');
