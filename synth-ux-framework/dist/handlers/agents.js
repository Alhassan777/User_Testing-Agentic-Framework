...
export function handleSynthUxFullTest(args) {
...
export function handleHeuristicEvaluate(args) {
...
export function handlePersonaGenerate(args) {
...
export function handleSessionSimulate(args) {
    const browser = loadAgentDefinition('browser_user');
...
Lock the browser and simulate the session as ${args.persona.name}.
`;
}
export function handleJtbdAnalyze(args) {
...
export function handleProblemSeverityClassify(args) {
...
export function handleReflectionInterview(args) {
...
Conduct the 12-question interview in character as ${args.persona.name}.
`;
}
...
export function handleSegmentHeatMap(args) {
...
export function handleVoiceOfUserDigest(args) {
