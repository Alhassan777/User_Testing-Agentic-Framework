...
export async function handleGenerateAnnotatedScreenshots(args) {
    ...
    try {
        ...
        return JSON.stringify({
            success: false,
            error: `Failed to parse figma_annotations.json: ${e.message}`,
        });
    }
    ...
    try {
        ...
        return JSON.stringify({
            success: false,
            error: `Failed to generate annotated screenshots: ${e.message}`,
            stack: e.stack,
        });
    }
}
